...
class plgSystemNNFrameworkHelper
{
	function __construct()
	{
		...
		JFactory::getDocument()->addScript(JURI::root(true) . '/plugins/system/nnframework/js/popup.min.js');
		//JFactory::getDocument()->addScript(JURI::root(true) . '/administrator/templates/js/template.js'); // Use instead of own js if pull request 492 is accepted
		JFactory::getDocument()->addStyleSheet(JURI::root(true) . '/administrator/templates/isis/css/template.css');
		JFactory::getDocument()->addStyleSheet(JURI::root(true) . '/plugins/system/nnframework/css/popup.min.css');
